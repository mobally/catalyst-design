 ...
 */
	...
	else
	{
		...
		wp_enqueue_style ('jquery-ui-theme', 'http://code.jquery.com/ui/1.12.1/themes/base/jquery-ui.min.css');
?>
		<script>
		jQuery(function($) {
...
<?php
	...
	echo "<form action='$F->action' method='$F->method' class='standard-form bps-form'>\n";
